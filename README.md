...
`![Hash Extraction](screenshots/01-hash-extracted.png)`
...
`![John CLI Crack](screenshots/02-john-cli-cracked.png)`
...
`![Johnny GUI Crack](screenshots/03-johnny-gui-cracked.png)`
